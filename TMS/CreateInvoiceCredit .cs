...
namespace TMS
{
    public class CreateInvoiceCredit : ServiceInstance
    {
        ...
        public Document CreateDocumentRegularCustomer(string name ,int id, string InvoiceNum, double sum, string customerEmail)
        {
            Document doc = new Document()
            {
                ...
                (token, sum, DocumentType.InvoiceCredit, int.Parse(InvoiceNum)),
