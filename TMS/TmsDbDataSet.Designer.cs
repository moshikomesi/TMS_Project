...
namespace TMS {
    ...
    public partial class TmsDbDataSet : global::System.Data.DataSet {
        ...
        public partial class Treatments_TypeDataTable : global::System.Data.TypedTableBase<Treatments_TypeRow> {
            ...
            private global::System.Data.DataColumn columnTreatments_Num;
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public global::System.Data.DataColumn Treatments_NumColumn {
                get {
                    return this.columnTreatments_Num;
                }
            }
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public Treatments_TypeRow FindByTreatments_Num(int Treatments_Num) {
                return ((Treatments_TypeRow)(this.Rows.Find(new object[] {
                            Treatments_Num})));
            }
            ...
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            internal void InitVars() {
                this.columnTreatments_Num = base.Columns["Treatments_Num"];
            ...
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            private void InitClass() {
                this.columnTreatments_Num = new global::System.Data.DataColumn("Treatments_Num", typeof(int), null, global::System.Data.MappingType.Element);
                base.Columns.Add(this.columnTreatments_Num);
                ...
                this.Constraints.Add(new global::System.Data.UniqueConstraint("Constraint1", new global::System.Data.DataColumn[] {
                                this.columnTreatments_Num}, true));
                this.columnTreatments_Num.AutoIncrement = true;
                this.columnTreatments_Num.AutoIncrementSeed = -1;
                this.columnTreatments_Num.AutoIncrementStep = -1;
                this.columnTreatments_Num.AllowDBNull = false;
                this.columnTreatments_Num.ReadOnly = true;
                this.columnTreatments_Num.Unique = true;
        ...
        public partial class Treatments_TypeRow : global::System.Data.DataRow {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public int Treatments_Num {
                get {
                    return ((int)(this[this.tableTreatments_Type.Treatments_NumColumn]));
                }
                set {
                    this[this.tableTreatments_Type.Treatments_NumColumn] = value;
                }
            }
...
namespace TMS.TmsDbDataSetTableAdapters {
    ...
    public partial class Treatments_TypeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            tableMapping.ColumnMappings.Add("Treatments_Num", "Treatments_Num");
            tableMapping.ColumnMappings.Add("Treatments_Type", "Treatments_Type");
            this._adapter.TableMappings.Add(tableMapping);
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Treatments_Type] WHERE (([Treatments_Num] = @Original_Treatmen" +
                "ts_Num) AND ([Treatments_Type] = @Original_Treatments_Type))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Treatments_Num", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Treatments_Num", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Treatments_Type", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Treatments_Type", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Treatments_Type] ([Treatments_Type]) VALUES (@Treatments_Type)" +
                ";\r\nSELECT Treatments_Num, Treatments_Type FROM Treatments_Type WHERE (Treatments" +
                "_Num = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Treatments_Type] SET [Treatments_Type] = @Treatments_Type WHERE (([Treatments_Num] = @Original_Treatments_Num) AND ([Treatments_Type] = @Original_Treatments_Type));
SELECT Treatments_Num, Treatments_Type FROM Treatments_Type WHERE (Treatments_Num = @Treatments_Num)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Treatments_Type", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Treatments_Type", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Treatments_Num", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Treatments_Num", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Treatments_Type", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Treatments_Type", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Treatments_Num", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "Treatments_Num", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Treatments_Num, Treatments_Type FROM dbo.Treatments_Type";
        ...
        public virtual int Fill(TmsDbDataSet.Treatments_TypeDataTable dataTable) {
        ...
        public virtual TmsDbDataSet.Treatments_TypeDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            TmsDbDataSet.Treatments_TypeDataTable dataTable = new TmsDbDataSet.Treatments_TypeDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(TmsDbDataSet.Treatments_TypeDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Treatments_Num, string Original_Treatments_Type) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_Treatments_Num));
            if ((Original_Treatments_Type == null)) {
                throw new global::System.ArgumentNullException("Original_Treatments_Type");
            }
            else {
                this.Adapter.DeleteCommand.Parameters[1].Value = ((string)(Original_Treatments_Type));
            }
        ...
        public virtual int Update(string Treatments_Type, int Original_Treatments_Num, string Original_Treatments_Type, int Treatments_Num) {
            if ((Treatments_Type == null)) {
                throw new global::System.ArgumentNullException("Treatments_Type");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[0].Value = ((string)(Treatments_Type));
            }
            this.Adapter.UpdateCommand.Parameters[1].Value = ((int)(Original_Treatments_Num));
            if ((Original_Treatments_Type == null)) {
                throw new global::System.ArgumentNullException("Original_Treatments_Type");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[2].Value = ((string)(Original_Treatments_Type));
            }
            this.Adapter.UpdateCommand.Parameters[3].Value = ((int)(Treatments_Num));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Treatments_Type, int Original_Treatments_Num, string Original_Treatments_Type) {
            return this.Update(Treatments_Type, Original_Treatments_Num, Original_Treatments_Type, Original_Treatments_Num);
        }
    }
